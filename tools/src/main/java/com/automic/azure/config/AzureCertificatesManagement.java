...
/**
 * AzureCertificatesManagement holds certificates for connecting to an HTTPS-secured Azure instance
 * with client/server authentication.
 */
public class AzureCertificatesManagement {
  ...
  private  SSLContext setSSLSocketContext(String keyStoreName, String password)
      throws UnrecoverableKeyException, KeyStoreException, NoSuchAlgorithmException,
      KeyManagementException, IOException, AzureException {
