...
public enum Action {
    ...
    GET_SUBSCRIPTION_INFO, VM_STATE, CHECK_REQUEST_STATUS, DELETE_VM,
    CREATE_VM_DEPLOYMENT, CREATE_STORAGE_CONTAINER,DELETE_STORAGE_CONTAINER,CREATE_CLOUD_SERVICE, DELETE_BLOB, DELETE_FILE, PUT_BLOB, CREATE_VIRTUAL_NETWORK;
