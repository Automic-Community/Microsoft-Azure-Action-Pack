...
/**
 * Factory class to create instances of implementations of {@link AbstractAction}. This class will
 * create the instances based on {@link Action} parameter. It throws an Exception if no matching
...
public final class ActionFactory {
  ...
  /**
   * Method to return instance of implementation of {@link AbstractAction} based on value of enum
   * {@link Action} passed.
   * 
   * @param enumAction
