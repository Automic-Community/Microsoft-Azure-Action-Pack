...
/**
 * 
 * Utility Class that has many utility methods to put validations on
 * {@link Object}, {@link String}, {@link File}.
 *
 */
public final class Validator {
	...
	/**
	 * Method to check if path specified by string literal is a Directory and it
	 * exists or not
	 * 
	 * @param dir
	 * @return true or false
	...
	public static boolean checkFileDirectoryExists(String filePath) {
		...
		if (checkNotEmpty(filePath)) {
			...
			ret = checkNotNull(folderPath) && folderPath.exists()
					&& !folderPath.isFile();
		}
		return ret;
	}
